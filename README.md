...
- MCP HTTP server runs on `MCP_PORT` (default `3001`) and also accepts `/mcp` on the main API app. Supported tools: list focused pending tasks, take unassigned tasks, change status of self-assigned tasks, and comment on self-assigned tasks.
